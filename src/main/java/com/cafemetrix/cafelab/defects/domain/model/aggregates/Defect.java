...
public class Defect extends AuditableAbstractAggregateRoot<Defect> {
     ...
     */
    public Defect(Long coffeeId, String name, String defectType, Double defectWeight, Double percentage, String probableCause, String suggestedSolution,Long userId) {
