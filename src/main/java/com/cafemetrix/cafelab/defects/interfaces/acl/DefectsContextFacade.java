...
public interface DefectsContextFacade {
     ...
     */
    Long createDefect(Long coffeeId, String name, String defectType, Double defectWeight, Double percentage, String probableCause, String suggestedSolution, Long userId);
